...
double taxaCross = 0.6; //0.6;						// taxa de crossover
double taxaMut = 1.0/lcrom;  //1.0/lcrom;					// taxa de mutacao
...
int tamCiclo = maxGen/100; //10   //maxGen/100;				// tamanho do ciclo de hipermutação
